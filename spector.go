...
import (
	...
	fiberadapter "github.com/bakhod1r/spector/internal/adapter/fiber"
	ginadapter "github.com/bakhod1r/spector/internal/adapter/gin"
	gorillamuxadapter "github.com/bakhod1r/spector/internal/adapter/gorillamux"
	httprouteradapter "github.com/bakhod1r/spector/internal/adapter/httprouter"
	stdlibadapter "github.com/bakhod1r/spector/internal/adapter/stdlib"
	"github.com/bakhod1r/spector/internal/advice"
	"github.com/bakhod1r/spector/internal/contract"
	"github.com/bakhod1r/spector/internal/core"
	"github.com/bakhod1r/spector/internal/evolve"
	"github.com/bakhod1r/spector/internal/gen"
	"github.com/bakhod1r/spector/internal/gqlgenx"
	"github.com/bakhod1r/spector/internal/graphqlsdl"
	"github.com/bakhod1r/spector/internal/grpcx"
	"github.com/bakhod1r/spector/internal/lint"
	"github.com/bakhod1r/spector/internal/middleware"
	"github.com/bakhod1r/spector/internal/mock"
	"github.com/bakhod1r/spector/internal/pbgo"
	"github.com/bakhod1r/spector/internal/proto"
	"github.com/bakhod1r/spector/internal/proxy"
	"github.com/bakhod1r/spector/internal/sdk"
	"github.com/bakhod1r/spector/internal/source"
	"github.com/bakhod1r/spector/internal/ui"
)
...
const accessCookie = "spector_key"
...
func authorized(r *http.Request, key string) bool {
	...
	if v := r.Header.Get("X-Spector-Key"); v != "" &&
...
//
// The contract artefacts check a document with requests Spector invented; this
...
// document lacks are added and marked x-spector-observed, and documented routes
...
// exactly as the current document is, so a change in how Spector reads code
...
func revisionDoc(cfg Config, rev string) (*Document, error) {
	...
	tmp, err := os.MkdirTemp("", "spector-since-")
	if err != nil {
		return nil, err
	}
	// The export directory is this function's alone, and a failure to remove
	// it leaves a directory in the system temp that the OS reclaims.
...
// paths or line numbers. The field is json:"x-spector-source,omitempty", so
...
// response status is documented. The tests target SPECTOR_BASE_URL and skip
// when it is unset.
...
func Handler(cfg Config) http.Handler {
	...
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if err != nil {
			http.Error(w, "spector: "+err.Error(), http.StatusInternalServerError)
			return
		}
